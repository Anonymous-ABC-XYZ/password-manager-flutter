    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          Expanded(
            child: ListView(
              children: [
                ...
                _buildNavItem(context, 1, Icons.list_alt, 'Credentials'), // Mapped to PasswordsPage
                ...
                _buildNavItem(context, 4, Icons.security, 'Security', enabled: false),
              ],
            ),
          ),
          ...
          _buildNavItem(context, -1, Icons.brightness_6, 'Toggle Theme', onTap: onThemeToggle),
        ],
      ),
    );
  }

  Widget _buildNavItem(BuildContext context, int index, IconData icon, String label, {bool enabled = true, VoidCallback? onTap}) {
        ...
        child: InkWell(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
              color: isSelected ? BentoColors.of(context).primary : Colors.transparent,
              borderRadius: BorderRadius.circular(50), // Fully rounded as per design
              boxShadow: isSelected
                  ? [
                      BoxShadow(
                        color: BentoColors.of(context).primary.withValues(alpha: 0.2),
                        blurRadius: 8,
              ...
              children: [
                Icon(
                  ...
                  color: isSelected
                      ...
                      : (enabled ? BentoColors.of(context).textMuted : BentoColors.of(context).surfaceHover),
                  size: 20,
                ),
